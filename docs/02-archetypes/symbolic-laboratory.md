# The Symbolic Laboratory

The priority structure comes first. The archetypal name is a hypothesis laid over it.

A good symbol does not merely label a configuration. It opens a compressed library of posture, motive, danger, social role, virtue, corruption, and inherited story. **King** carries centuries of accumulated meaning. “Dignity–Recognition Type A” carries none.

But symbolic force can also seduce us. A name may sound ancient, powerful, or esoteric while mapping the structure badly. The laboratory exists to prevent that mistake.

> **The coordinates outrank the costume.**

## The matrix

PBMM crosses three establishing priorities with three realizing priorities:

```text
                         RECOGNITION        HARMONY             COMFORT

DIGNITY                  King / Queen      Gentleman / Lady    Patriarch / Matriarch

SECURITY                 Champion / Diva   ? / ?               Steward / Hearthkeeper
...
Finally, the figure must be inhabitable.
...
Do not choose names merely to complete the table. Do not force every cell into a tidy male–female pair. Do not use novelty where inherited language already carries more weight. Do not preserve an inherited symbol when its history overwhelms the structure it is meant to reveal.

Search myth, religion, epic, tarot, courtly roles, ritual offices, ancient household forms, dramatic stock characters, and traditional crafts—but do not force the whole system into any one tradition.

Esoteric depth should make the symbol richer on return, not incomprehensible on arrival.
